...
export const FilterMultiselect = <TItem extends object>({
    column
}: {
    ...
    console.log(column.getFilterFn()?.name)

    return (<div ref={filterContainer} style={{ display: "flex", flexDirection: "column", maxHeight: "300px", width: "200px", overflowY: "auto" }}>
